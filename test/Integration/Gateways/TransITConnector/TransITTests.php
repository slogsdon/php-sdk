...
use GlobalPayments\Api\Entities\TransIT\ProductDetails;
use GlobalPayments\Api\Entities\TransIT\ProductDiscountDetails;
use GlobalPayments\Api\Entities\TransIT\ProductModifierDetails;
use GlobalPayments\Api\Entities\TransIT\ProductTaxDetails;
use GlobalPayments\Api\Entities\TransIT\TransDiscountDetails;
use GlobalPayments\Api\Entities\TransIT\TransDiscount;
...
class CreditTest extends TestCase
{
    ...
    public function getProductDetails()
    {
        ...
        $productDetails->productCode = "PRD 1011";
        $productDetails->productName = "product1";
        $productDetails->price = 60;
        $productDetails->quantity = 6;
        $productDetails->measurementUnit = 1;
        $productDetails->productVariation = "Color -Blue Size - XL";
        $productDetails->productNotes = "This is a Test Product Notes";
        
        $productTaxDetails = new ProductTaxDetails();
        $productTaxDetails->productTaxName = "Tax4";
        $productTaxDetails->productTaxAmount = 6;
        $productTaxDetails->productTaxPercentage = 0.03;
        
        $productModfierDetails = new ProductModifierDetails();
        $productModfierDetails->modifierName = "Modifier1";
        $productModfierDetails->modifierValue = "modifierValue1";
        $productModfierDetails->modifierPrice = 123;
        
        $productDiscountDetails = new ProductDiscountDetails();
        $productDiscountDetails->productDiscountIndicator = 'Y';
        $productDiscountDetails->productCommodityCode = '12DIGIT ACCO';
        $productDiscountDetails->alternateTaxID = 'ALT TAX';
        $productDiscountDetails->creditIndicator = 'YES';
        $productDiscountDetails->productDiscountName = "ProdDiscount5";
        $productDiscountDetails->productDiscountAmount = 1;
        $productDiscountDetails->productDiscountPercentage = 0.01;
        $productDiscountDetails->productDiscountType = "testproducttype";
        $productDiscountDetails->priority = 1;
        $productDiscountDetails->stackable = 1;
        $productDiscountDetails->productModifierDetails = [$productModfierDetails];
        $productDiscountDetails->productTaxDetails = [$productTaxDetails];

        $productDetails->productDiscountDetails = [$productDiscountDetails];
    ...
    {
        $transDiscountDetails = new TransDiscountDetails();
        
        $transDiscount = new TransDiscount();
        $transDiscount->transDiscountName = "XmaxSale1";
        $transDiscount->transDiscountAmount = 10;
        $transDiscount->transDiscountPercentage = 0.50;
        $transDiscount->priority = 1;
        $transDiscount->stackable = 1;
        
        $transDiscountDetails->transTotalDiscountAmount = 5;
        $transDiscountDetails->transDiscount = [$transDiscount];
        
        return $transDiscountDetails;
    }
    
    public function testSaleWithProductDetails()
    {
        
        $response = $this->card->charge(100)
            ->withCurrency('USD')
            ->withProductData($this->getProductDetails())
            ->withDiscountDetails($this->getDiscountDetails())
            ->execute();
